...
func (c *helloClient) Hello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRsp, error) {
	out := new(HelloRsp)
...
func (UnimplementedHelloServer) Hello(context.Context, *HelloReq) (*HelloRsp, error) {
